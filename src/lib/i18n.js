...
const translations = {
  ...
  hero: {
    ...
    subtitle: {
      en: 'The AI sports medicine platform that prevents injuries before they happen. Connect 5+ wearables, manage your team, track recovery, and train with confidence.',
      es: 'La plataforma de medicina deportiva con IA que previene lesiones antes de que ocurran. Conecta 5+ wearables, gestiona tu equipo, rastrea la recuperación y entrena con confianza.',
    },
    ctaPrimary: { en: 'Get Started Free', es: 'Empieza Gratis' },
    ctaSecondary: { en: 'View Pricing', es: 'Ver Precios' },
  ...
  finalCta: {
    ...
    subtitle: {
      en: 'Join thousands of athletes and coaches who train smarter with AI-powered injury prevention.',
      es: 'Únete a miles de atletas y coaches que entrenan más inteligente con prevención de lesiones con IA.',
    },
    emailPlaceholder: { en: 'Enter your email', es: 'Ingresa tu email' },
    joinWaitlist: { en: 'Get Started Free', es: 'Empieza Gratis' },
    success: {
  ...
  featuresGrid: {
    tag: { en: 'Platform Features', es: 'Características de la Plataforma' },
    title: { en: 'Everything you need to train smarter', es: 'Todo lo que necesitas para entrenar más inteligente' },
    subtitle: {
      en: 'A complete sports medicine platform — from AI readiness scores to team analytics.',
      es: 'Una plataforma de medicina deportiva completa — desde scores de preparación con IA hasta analítica de equipo.',
    },
    items: {
      en: [
        { icon: '📊', title: 'AI Readiness Score', desc: 'Proprietary algorithm combining 40+ biomarkers into a single daily readiness score.' },
        { icon: '⌚', title: '5 Wearable Integrations', desc: 'Connect Oura, WHOOP, Garmin, Fitbit, and Apple Health in seconds.' },
        { icon: '👥', title: 'Coach/Doctor Dashboard', desc: 'Monitor your entire roster at a glance with multi-athlete management.' },
        { icon: '💬', title: 'Real-time Chat', desc: 'Instant messaging between coaches, doctors, and athletes — all in one place.' },
        { icon: '🎯', title: 'Goals & Progress', desc: 'Set custom objectives, track milestones, and celebrate achievements.' },
        { icon: '🦴', title: 'Injury Log & RTP', desc: 'Full injury tracking with 6-phase Return-to-Play protocol.' },
        { icon: '📋', title: 'Weekly Reports', desc: 'Automated email and in-app performance summaries every Monday.' },
        { icon: '📈', title: 'Team Analytics', desc: 'Risk matrix, leaderboard, and aggregate insights across your team.' },
        { icon: '📱', title: 'Install as App', desc: 'Progressive Web App — install on any device for a native experience.' },
        { icon: '🔒', title: 'Data Export', desc: 'Download your health data anytime in CSV or JSON format.' },
      ],
      es: [
        { icon: '📊', title: 'Score de Preparación IA', desc: 'Algoritmo propietario que combina 40+ biomarcadores en un score diario.' },
        { icon: '⌚', title: '5 Integraciones Wearable', desc: 'Conecta Oura, WHOOP, Garmin, Fitbit y Apple Health en segundos.' },
        { icon: '👥', title: 'Dashboard Coach/Doctor', desc: 'Monitorea a todo tu equipo de un vistazo con gestión multi-atleta.' },
        { icon: '💬', title: 'Chat en Tiempo Real', desc: 'Mensajería instantánea entre coaches, doctores y atletas — todo en un lugar.' },
        { icon: '🎯', title: 'Metas y Progreso', desc: 'Establece objetivos personalizados, rastrea hitos y celebra logros.' },
        { icon: '🦴', title: 'Registro de Lesiones & RTP', desc: 'Seguimiento completo de lesiones con protocolo de Retorno al Juego de 6 fases.' },
        { icon: '📋', title: 'Reportes Semanales', desc: 'Resúmenes de rendimiento automatizados por email y en la app cada lunes.' },
        { icon: '📈', title: 'Analítica de Equipo', desc: 'Matriz de riesgo, clasificación e insights agregados de tu equipo.' },
        { icon: '📱', title: 'Instalar como App', desc: 'Progressive Web App — instala en cualquier dispositivo como app nativa.' },
        { icon: '🔒', title: 'Exportar Datos', desc: 'Descarga tus datos de salud en cualquier momento en formato CSV o JSON.' },
      ],
    },
  },

  // ===================== LANDING: COACH/DOCTOR SECTION =====================
  coachSection: {
    tag: { en: 'For Coaches & Doctors', es: 'Para Coaches y Médicos' },
    title: { en: 'Your team. One dashboard.', es: 'Tu equipo. Un solo dashboard.' },
    subtitle: {
      en: 'Manage, monitor, and communicate with every athlete from a single command center.',
      es: 'Gestiona, monitorea y comunícate con cada atleta desde un solo centro de comando.',
    },
    cards: {
      en: [
        { icon: '👥', title: 'Multi-Athlete Grid', desc: 'See every athlete\'s Wellaryn Score, status, and alerts in a filterable grid.' },
        { icon: '🔴', title: 'Real-time Alerts', desc: 'Get instant notifications when an athlete enters a danger zone.' },
        { icon: '🗺️', title: 'Risk Matrix', desc: 'Visual heatmap of injury risk across your entire roster.' },
        { icon: '🦴', title: 'Injury & RTP Tracking', desc: 'Log injuries, advance RTP phases, and track recovery timelines.' },
      ],
      es: [
        { icon: '👥', title: 'Grid Multi-Atleta', desc: 'Ve el Score Wellaryn, estado y alertas de cada atleta en una grilla filtrable.' },
        { icon: '🔴', title: 'Alertas en Tiempo Real', desc: 'Recibe notificaciones instantáneas cuando un atleta entra en zona de peligro.' },
        { icon: '🗺️', title: 'Matriz de Riesgo', desc: 'Mapa de calor visual del riesgo de lesión en todo tu equipo.' },
        { icon: '🦴', title: 'Seguimiento Lesiones & RTP', desc: 'Registra lesiones, avanza fases RTP y rastrea líneas de tiempo de recuperación.' },
      ],
    },
  },
  ...
  integrations: {
    tag: { en: 'Integrations', es: 'Integraciones' },
    title: { en: 'Connect your favorite wearables', es: 'Conecta tus wearables favoritos' },
    subtitle: {
      en: 'Wellaryn syncs with the devices you already wear — no extra hardware needed.',
      es: 'Wellaryn se sincroniza con los dispositivos que ya usas — sin hardware adicional.',
    },
    devices: {
      en: [
        { name: 'Oura Ring', status: 'Connected' },
        { name: 'WHOOP', status: 'Connected' },
        { name: 'Garmin', status: 'Connected' },
        { name: 'Fitbit', status: 'Connected' },
        { name: 'Apple Health', status: 'Coming Soon' },
      ],
      es: [
        { name: 'Oura Ring', status: 'Conectado' },
        { name: 'WHOOP', status: 'Conectado' },
        { name: 'Garmin', status: 'Conectado' },
        { name: 'Fitbit', status: 'Conectado' },
  ...
  testimonials: {
    tag: { en: 'Testimonials', es: 'Testimonios' },
    title: { en: 'Trusted by athletes and coaches worldwide', es: 'La confianza de atletas y coaches en todo el mundo' },
    items: {
      en: [
        { quote: 'Wellaryn changed how I approach recovery days. My injury rate dropped dramatically this season.', author: 'Carlos M.', role: 'Marathon Runner' },
        { quote: 'Having all my athletes\' readiness data in one dashboard saves me hours every week.', author: 'Sarah K.', role: 'Strength Coach' },
        { quote: 'The Return-to-Play protocol gave me and my doctor a shared framework for my ACL recovery.', author: 'Diego R.', role: 'Semi-Pro Soccer Player' },
      ],
      es: [
        { quote: 'Wellaryn cambió cómo abordo los días de recuperación. Mi tasa de lesiones bajó dramáticamente esta temporada.', author: 'Carlos M.', role: 'Corredor de Maratón' },
        { quote: 'Tener los datos de preparación de todos mis atletas en un dashboard me ahorra horas cada semana.', author: 'Sarah K.', role: 'Coach de Fuerza' },
        { quote: 'El protocolo de Retorno al Juego nos dio a mí y a mi doctor un marco compartido para mi recuperación de LCA.', author: 'Diego R.', role: 'Futbolista Semi-Pro' },
      ],
    },
  },
  ...
  pricingPreview: {
    tag: { en: 'Pricing', es: 'Precios' },
    title: { en: 'Simple, transparent pricing', es: 'Precios simples y transparentes' },
    subtitle: {
      en: 'Start free. Upgrade when you need more.',
      es: 'Empieza gratis. Mejora cuando necesites más.',
    },
    free: { en: 'Free', es: 'Gratis' },
    freeDesc: { en: 'Basic readiness score & 7-day history', es: 'Score básico e historial de 7 días' },
    freePrice: { en: '$0', es: '$0' },
    pro: { en: 'Pro', es: 'Pro' },
    proDesc: { en: 'Full history, all wearables, goals & export', es: 'Historial completo, todos los wearables, metas y exportación' },
    proPrice: { en: '$9', es: '$9' },
    team: { en: 'Team', es: 'Equipo' },
    teamDesc: { en: 'Multi-athlete, analytics, chat & injury log', es: 'Multi-atleta, analítica, chat y registro de lesiones' },
    teamPrice: { en: '$29', es: '$29' },
    perMonth: { en: '/mo', es: '/mes' },
    viewAll: { en: 'View All Plans', es: 'Ver Todos los Planes' },
    getStarted: { en: 'Get Started Free', es: 'Empieza Gratis' },
  ...
  dashboard: {
    ...
    admin: {
      ...
      subtitle: { en: 'Platform management and analytics', es: 'Gestión y analítica de la plataforma' },
      adminAccess: { en: 'Admin Access', es: 'Acceso Admin' },
      totalUsers: { en: 'Total Users', es: 'Usuarios Totales' },
      activeUsers: { en: 'Active Users', es: 'Usuarios Activos' },
      totalDataPoints: { en: 'Data Points', es: 'Puntos de Datos' },
      revenue: { en: 'Est. Revenue', es: 'Ingreso Est.' },
      newUsers: { en: 'New Users', es: 'Nuevos Usuarios' },
      conversionRate: { en: 'Conversion Rate', es: 'Tasa de Conversión' },
      growthChart: { en: 'User Growth', es: 'Crecimiento de Usuarios' },
      planDistribution: { en: 'Plan Distribution', es: 'Distribución de Planes' },
      userManagement: { en: 'User Management', es: 'Gestión de Usuarios' },
      searchPlaceholder: { en: 'Search by name or email...', es: 'Buscar por nombre o email...' },
      ...
      joined: { en: 'Joined', es: 'Registro' },
      lastActive: { en: 'Last Active', es: 'Último Acceso' },
      actions: { en: 'Actions', es: 'Acciones' },
      changeRole: { en: 'Change Role', es: 'Cambiar Rol' },
      changePlan: { en: 'Change Plan', es: 'Cambiar Plan' },
      deleteUser: { en: 'Delete User', es: 'Eliminar Usuario' },
      deleteConfirm: { en: 'Are you sure you want to delete', es: '¿Estás seguro de que deseas eliminar a' },
      actionSuccess: { en: 'Action completed', es: 'Acción completada' },
      noUsers: { en: 'No users found', es: 'No se encontraron usuarios' },
      cancel: { en: 'Cancel', es: 'Cancelar' },
      confirm: { en: 'Confirm', es: 'Confirmar' },
      systemHealth: { en: 'System Health', es: 'Estado del Sistema' },
      apiResponse: { en: 'API Response', es: 'Respuesta API' },
      databaseSize: { en: 'Database Size', es: 'Tamaño de BD' },
      activeConnections: { en: 'Active Connections', es: 'Conexiones Activas' },
      lastDeploy: { en: 'Last Deploy', es: 'Último Deploy' },
      inviteCodes: { en: 'Invite Codes', es: 'Códigos de Invitación' },
      generateCode: { en: 'Generate Code', es: 'Generar Código' },
      revokeCode: { en: 'Revoke', es: 'Revocar' },
      noInvites: { en: 'No pending invitations', es: 'Sin invitaciones pendientes' },
    },
    analytics: {
      title: { en: 'Team Analytics', es: 'Analítica del Equipo' },
      subtitle: { en: 'Aggregate performance insights', es: 'Insights de rendimiento agregado' },
      totalAthletes: { en: 'Total Athletes', es: 'Total de Atletas' },
      teamAvg: { en: 'Team Avg Score', es: 'Score Promedio Equipo' },
      alertZone: { en: 'In Alert Zone', es: 'En Zona de Alerta' },
      mostImproved: { en: 'Most Improved', es: 'Más Mejorado' },
      distribution: { en: 'Score Distribution', es: 'Distribución de Scores' },
      comparison: { en: 'Score Comparison', es: 'Comparación de Scores' },
      trends: { en: 'Team Trends', es: 'Tendencias del Equipo' },
      riskMatrix: { en: 'Risk Matrix', es: 'Matriz de Riesgo' },
      leaderboard: { en: 'Leaderboard', es: 'Clasificación' },
      rank: { en: 'Rank', es: 'Posición' },
      streak: { en: 'Streak', es: 'Racha' },
      noData: { en: 'Connect athletes to see team analytics', es: 'Conecta atletas para ver analítica del equipo' },
    },
    goals: {
    ...
    export: {
      title: { en: 'Export Data', es: 'Exportar Datos' },
      subtitle: { en: 'Download your health data', es: 'Descarga tus datos de salud' },
      dateRange: { en: 'Date Range', es: 'Rango de Fechas' },
      from: { en: 'From', es: 'Desde' },
      to: { en: 'To', es: 'Hasta' },
      format: { en: 'Format', es: 'Formato' },
      dataSelection: { en: 'Data to Export', es: 'Datos a Exportar' },
      metrics: { en: 'Daily Metrics', es: 'Métricas Diarias' },
      scores: { en: 'Wellaryn Scores', es: 'Scores Wellaryn' },
      training: { en: 'Training Load', es: 'Carga de Entrenamiento' },
      goals: { en: 'Goals', es: 'Metas' },
      injuries: { en: 'Injury Log', es: 'Registro de Lesiones' },
      download: { en: 'Download Export', es: 'Descargar Exportación' },
      generating: { en: 'Generating...', es: 'Generando...' },
      success: { en: 'Export downloaded successfully!', es: '¡Exportación descargada exitosamente!' },
      noData: { en: 'No data found for the selected range.', es: 'No se encontraron datos para el rango seleccionado.' },
      selectAthlete: { en: 'Select Athlete', es: 'Seleccionar Atleta' },
    },
  },
