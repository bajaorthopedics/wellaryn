  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `When you connect a wearable device or health app to Wellaryn, you authorize us to collect and process the biometric data described in our Privacy Policy. You may disconnect a device at any time through your account settings.\n\nWe are not responsible for the accuracy of data provided by third-party devices or apps. Different wearable brands may measure the same metric (e.g., HRV) using different algorithms, which is why your Readiness Score is always based on your personal baseline, never compared against other users.`,
      },
      {
